...
class MuZeroConfig:
    def __init__(self):
        ...
        self.population_size_es = 80 # number of parameter sets to test (after perturbation)
        ...
        self.training_steps = 320000  # Total number of training steps (ie weights update according to a batch)
