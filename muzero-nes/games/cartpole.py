...
class MuZeroConfig:
    def __init__(self):
        ...
        # nes parameters
        self.num_es_workers = 10
        self.num_layers_es = 2
        self.hidden_layer_size_es = 32
        
        self.population_size_es = 100
        self.noise_std_dev_es = 0.1
        self.learning_rate_es = 0.01
        self.generation_es = 5
        self.num_actions_es = 50
