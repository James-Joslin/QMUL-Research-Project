...
class MuZero:
    ...
    def __init__(self, game_name, config=None, split_resources_in=1):
        ...
        self.checkpoint["controller_weights"] = models.SimpleNet(
    ...
    def train(self, log_in_tensorboard=True):
        ...
        self.controller_worker = controller_trainer.SelfPlay.options(
                num_cpus=0,
                num_gpus=0,
            ).remote(
                self.checkpoint,
        ...
        # Launch workers
        self.controller_worker.continuous_self_play.remote(
    ...
    def load_model(self, checkpoint_path=None, replay_buffer_path=None):
        ...
        if checkpoint_path:
            ...
            print(f'Loaded MuZero Model and Controller network from {checkpoint_path}')
...
def load_model_menu(muzero, game_name):
    ...
    if choice == (len(options) - 1):
        ...
        if not os.path.isfile(replay_buffer_path):
            print("No buffer found for this model\nModel will be loaded with an empty buffer instead")
    ...
    if len(sys.argv) == 2:
        ...
        while True:
            ...
            if choice == 0:
                ...
                muzero.test(render=True, opponent="self", num_tests=1, muzero_player=None)
            elif choice == 4:
