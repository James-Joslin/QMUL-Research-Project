...
class MuZeroConfig:
    def __init__(self):
        ...
        # Beam Search parameters - implemented after paper's conclusion
        # They are currently static and ahve no dynamic mechanism
        # Leaving as 1 and 1 will mean they have no effect as they are multipliers
        self.reward_heuristic_discount = 1
        self.value_heuristic_discount = 1
    ...
    def visit_softmax_temperature_fn(self, trained_steps):
        ...
        # else:
        #     return 0.05
        return 6 # no stepped tempearture
